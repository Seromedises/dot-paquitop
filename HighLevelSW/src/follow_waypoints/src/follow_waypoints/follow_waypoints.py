...
class FollowPath(State):
    def __init__(self):
        ...
        self.distance_tolerance = rospy.get_param('waypoint_distance_tolerance', 0.75)
...
class GetPath(State):
    ...
    def execute(self, userdata):
        ...
        def wait_for_path_ready():
            ...
            with open(output_file_path, 'a') as file: #prima era in modalita' w
        ...
        def wait_for_start_journey():
            ...
            input_file_path = rospkg.RosPack().get_path('follow_waypoints')+"/saved_path/pose_back.csv"
