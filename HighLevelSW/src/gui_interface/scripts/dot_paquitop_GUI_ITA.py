...
class DOT_PAQUITOP_GUI(MDApp):
    ...
    def build(self):
        ...
        self.image = Image(pos_hint={"center_x": .75, "center_y":0.60},size_hint=(.5,.8),keep_ratio=True)
    ...
    def identificationOK(self, name):
        ...
        self.layout.ids.identification.text = "Ciao " + name + "!"
    ...
    def goON(self, *args):
        ...
        self.layout.ids.identification.text = "Inquadra il braccialetto"
        
        self.layout.ids.bodyTemp_text.text_color = (.95, .95, .95, 1)
